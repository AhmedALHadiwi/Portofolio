...
const techStacks = [
  { icon: "html.svg", language: "PHP" },
  { icon: "css.svg", language: "Laravel" },
  { icon: "javascript.svg", language: "JavaScript" },
  { icon: "tailwind.svg", language: "React" },
  { icon: "reactjs.svg", language: "MySQL" },
  { icon: "vite.svg", language: "Python" },
  { icon: "nodejs.svg", language: "Java" },
  { icon: "bootstrap.svg", language: "C++" },
  { icon: "tailwind.svg", language: "Tailwind CSS" },
  { icon: "MUI.svg", language: "Git" },
  { icon: "vercel.svg", language: "GitHub" },
  { icon: "SweetAlert.svg", language: "Postman" },
];
  ...
  const projects = [
    {
      ...
      Description:
        "Designed and developed a multi-tenant SaaS platform for travel agencies to manage reservations, employees, and daily operations through a modern REST API architecture.",
    ...
    },
    {
      ...
      Description:
        "Developed a complete food ordering platform connecting restaurants with customers through a decoupled Laravel API and React frontend.",
