...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://linkedin.com/in/ahmed-mohamed-255904334",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@AhmedALHadiwi",
    icon: Instagram,
    url: "https://www.instagram.com/ahmed_alhadiwi?igsh=MTZoYmV5eTBlZWJxMQ==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@AhmedALHadiwi",
    icon: Github,
    url: "https://github.com/AhmedALHadiwi",
    color: "#ffffff",
